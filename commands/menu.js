        ...
        try {
            ...
            if (args.length > 0) {
                ...
                if (command) {
                    ...
                    let cmdInfo = `╭────❒ *📋 COMMAND INFO* ❒├⬡ *Name:* ${command.name}
...
├⬡ Current bot prefix: ${global.prefix || '/'}`;
            helpMessage += `\n├⬡ *TIP:* Use \`${global.prefix || '/'}help <command>\` to see detailed info about a specific command.`;
            helpMessage += `\n╰────────────❒\n\n`;
            
            helpMessage += `EF-PRIME-MD-v2`;
